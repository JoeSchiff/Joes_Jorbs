...
STATIC_BLACKLIST = (
    ...
    "co.essex.ny.us/personnel",
    "co.ontario.ny.us/94/human-resources",
    "countyherkimer.digitaltowpath.org:10069/content/departments/view/9:field=services;/content/departmentservices/view/190",
    "countyherkimer.digitaltowpath.org:10069/content/departments/view/9:field=services;/content/departmentservices/view/35",
    "cs.monroecounty.gov/mccs/lists",
    "herkimercounty.org/content/departments/view/9:field=services;/content/departmentservices/view/190",
    "herkimercounty.org/content/departments/view/9:field=services;/content/departmentservices/view/35",
    "jobs.albanyny.gov/default/jobs",
    "monroecounty.gov/hr/lists",
    "monroecounty.gov/mccs/lists",
    "mycivilservice.rocklandgov.com/default/jobs",
    "niagaracounty.com/employment/eligible-lists",
    "ogdensburg.org/index.aspx?nid=345",
    "penfield.org/multirss.php",
